...
def get_most_recent_activity():
    ...
    if  code != None:
        ...
        try:
            ...
            if hike:
                hike_info = f"Hike Name: {hike['name']}\nHike Distance: {hike['distance']}m\nElevation: {hike['total_elevation_gain']}m\nThe data above is generated by someone's phone, and as errors may occur. View this full activity on Strava at https://www.strava.com/activities/{hike['id']}"
                return hike_info
            ...
            if hikes.status_code == 200:
                ...
                if hike_list:
                    ...
                    for hike in hike_list:
                        result_list.append(f"Hike Name: {hike['name']}\nHike Distance: {hike['distance']}m\nElevation: {hike['total_elevation_gain']}m\nThe data above is generated by someone's phone, and as errors may occur. View this full activity on Strava at https://www.strava.com/activities/{hike['id']} \n\n")
                    return result_list
